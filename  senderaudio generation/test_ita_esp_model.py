...
def test_with_pipeline(text, output_path):
    ...
    wavfile.write(output_path, sample_rate, Referringaudio_array)
...
if __name__ == "__main__":
    ...
    print("\ifying[Test 3] Pipeline approach with longer text")
    try:
        test_with_pipeline(
