...
class Translator(ABC):
    ...
    def translate_paragraph(self, sentences):
        """
        Translate a paragraph (list of sentences) using the specific strategy.
    ...
    def translate_json_file(self, json_file_path, output_file_path):
        ...
        for i, paragraph in enumerate(data):
            ...
            # Translate the paragraph using the specific strategy
...
class SentenceBySentence(Translator):
    """
    Translator that translates sentence by sentence.
    """
...
class ParagraphByParagraph(Translator):
    """
    Translator that translates entire paragraphs at once.
    """
    
    def translate_paragraph(self, sentences):
        """
        Translate a paragraph as a whole by joining sentences first.
        ...
        translated_paragraph = self.translate_text(paragraph_text)
